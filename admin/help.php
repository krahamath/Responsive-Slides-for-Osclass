...
<div class="rslides_menu">
	<ul>
		...
		<li class="active"><a href="<?php echo osc_admin_render_plugin_url("responsive_slides/admin/help.php"); ?>"><?php _e('Help', 'rslides'); ?></a></li>
	</ul>
</div>
<div class="rslides_content">
	<h2 class="render-title"><?php _e('Help', 'rslides'); ?></h2>

	<h3 class="render-title" style="margin-bottom: 0"><?php _e('What is ResponsiveSlides?', 'rslides'); ?></h3>
	...
	<h3 class="render-title" style="margin-bottom: 0"><?php _e('How to use?', 'rslides'); ?></h3>
	...
	<h3 class="render-title" style="margin-bottom: 0"><?php _e('Credits', 'rslides'); ?></h3>
	<p>Thanks to original authors <a href="http://forums.osclass.org/profile/?u=4527">RajaSekar</a> <?php _e('and', 'rslides'); ?> <a href="http://forums.osclass.org/profile/?u=1728">trains58554</a></p>
</div>